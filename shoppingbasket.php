...
<h1 style="color:#d9534f">My Shopping Basket</h1><br><br><br><?php
	...
	<?php
		...
		?>
	<div class="col-lg-4">
		<center><span style="font-size:21px; font-weight:600; color:#D11111">Total: ₹<?php echo $total; ?></span>
			<center><br>
				<center><a class="btn btn-danger" href="./customer.php" role="button" style="font-size:18px">BOOK NOW</a></center><br>

				<center><a href='shoppingbasket.php?empty=true' style="font-size:22px; font-weight:400; color:#D11111">Empty basket</a></center>
	</div>
<?php
} else {
