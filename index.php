...
<div class="col-lg-6" style="margin-left:-12px">
	<h1 style="color:#d9534f">Theater Booking System</h1><br>
			...
			<div class="thumbnail">
				<center>
					...
					<div class="caption">
						...
						<p>
							<a href="./performances.php?id=<?php echo $f['productionid'] ?>&name=<?php echo $f['productionname'] ?>" style="color:#D11111; font-size:18px">View Shows</a>
						</p>
					</div>
				</center>
			</div>
